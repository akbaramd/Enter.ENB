...
public class RepositoryRegistration_Tests
{
    ...
    public class MyTestEntityWithInt32Pk : EntEntity<int>
    {
        ...
        where TEntity : class, IEntEntity
    {
        ...
        public MyTestDefaultRepository(IEntLazyServiceProvider lazyServiceProvider) : base(lazyServiceProvider)
        {
        }
    }
    ...
    public class MyTestCustomBaseRepository<TEntity> : MyTestDefaultRepository<TEntity>
        where TEntity : class, IEntEntity
    {
        public MyTestCustomBaseRepository(IEntLazyServiceProvider lazyServiceProvider) : base(lazyServiceProvider)
        {
        }
    }
    ...
    {
        public MyTestAggregateRootWithDefaultPkCustomRepository(IEntLazyServiceProvider lazyServiceProvider) : base(lazyServiceProvider)
        {
        }
    }
