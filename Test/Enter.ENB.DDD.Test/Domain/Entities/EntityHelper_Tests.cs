...
public class EntityHelper_Tests
{
    ...
    private class MyEntityImplementsIEntity : IEntEntity<Guid>
    {
    ...
    private class MyEntityDisablesIdGeneration : EntEntity<Guid>
    {
        [DisableIdGeneration]
        public override Guid Id { get; protected set; }
    }

    public class NewIdEntity : EntEntity<Guid>
    {
        public new Guid Id {
            get => base.Id;
            set => base.Id = value;
