...
namespace Enter.ENB.Security.Encryption;
...
{
    protected EntStringEncryptionOptions Options { get; }

    public StringEncryptionService(IOptions<EntStringEncryptionOptions> options)
    {
