...
public class ModuleLoader : IModuleLoader
{
        ...
        Type startupModuleType)
    {
        ...
        foreach (var moduleType in EntModuleHelper.FindAllModuleTypes(startupModuleType))
        {
    ...
    {
        foreach (var dependedModuleType in EntModuleHelper.FindDependedModuleTypes(module.Type))
        {
