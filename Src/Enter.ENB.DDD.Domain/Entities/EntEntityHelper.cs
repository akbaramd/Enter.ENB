...
public static class EntityHelper
{
    ...
    public static void EntCheckEntity([NotNull] Type type)
    {
        EntCheck.NotNull(type, nameof(type));
        if (!IsEntity(type))
        {
    ...
    public static bool HasDefaultKeys([NotNull] IEntEntity entity)
    {
    ...
    /// May return null if given type does not implement <see cref="IEntEntity{TKey}"/>
    /// </summary>
    ...
    public static void TrySetId<TKey>(
        ...
        Func<TKey> idFactory,
        bool EntCheckForDisableIdGenerationAttribute = false)
    {
        ObjectHelper.TrySetProperty(
            entity,
            x => x.Id,
            idFactory,
            EntCheckForDisableIdGenerationAttribute
