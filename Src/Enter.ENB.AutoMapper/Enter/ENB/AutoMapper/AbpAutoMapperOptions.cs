...
{
    public List<Action<IEntAutoMapperConfigurationContext>> Configurators { get; }

    public ITypeList<Profile> ValidatingProfiles { get; set; }

    public EntAutoMapperOptions()
    {
        Configurators = new List<Action<IEntAutoMapperConfigurationContext>>();
